...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between py-5 font-medium">
      <div className="flex items-center  gap-2 text-3xl prata-regular">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
            <div className=" flex flex-col gap-2 w-42 py-3 px-5 bg-slate-100 text-gray-500 text-xl rounded">
        ...
        <Link to="/cart" className="relative">
          <img src={assets.cart_icon} alt="cart" className="w-7 min-w-5" />
          <p className="absolute right-[-5px] bottom-[-5px] w-5 text-center leading-5 bg-black text-white aspect-square rounded-full text-[14px]">
            10
          </p>
        </Link>
        <img
